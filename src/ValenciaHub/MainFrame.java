...
public class MainFrame extends JFrame {
    ...
    private int contador_metodo_examen;
    ...
    public MainFrame(){
        ...
        EXAMEN.addActionListener(e -> {
            if(e.getSource() == EXAMEN){
                if(a1RadioButton.isSelected()){
                    int a = p1.Metodo_Puerto_Examen(hubSelected(),1);
                    TextoExamen.setText(String.valueOf(a));
                }
                if(a2RadioButton.isSelected()){
                    int a = p1.Metodo_Puerto_Examen(hubSelected(),2);
                    TextoExamen.setText(String.valueOf(a));
                }
                if(a3RadioButton.isSelected()){
                    int a = p1.Metodo_Puerto_Examen(hubSelected(),3);
                    TextoExamen.setText(String.valueOf(a));
                }

                //SALTA ERROR SI OBVIAMENTE NO HEMOS RELLENADO PREVIAMENTE LOS PUERTOS CON SUS CONTENEDORES.
            }
        });
    }
